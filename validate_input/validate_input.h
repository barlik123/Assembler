...
/*
analyzes 'line' and saves opcode indexes 
*/
...
/*
validating that opcode that should get 0 operands acually gets 0 operands
ex: "stop" --> true
    "stop r3" --> false
*/
bool check_valid_0_operand(const char *line, int index);
/*
validating that opcode that should get 1 operand acually gets 1 operand (see example above)
*/
bool check_valid_1_operand(const char *line, char operand[], int index);
/*
validating that opcode that should get 2 operands acually gets 2 operands (see example above)
*/
